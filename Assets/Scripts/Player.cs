...
public class Player : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {   
            ...
            rankingManager.AddRankingEntry($"{minutes}:{seconds:00}", otherScore);
        ...
        else if (otherScore >= targetScore)
        {
           string playerName = System.DateTime.Now.ToString("dd-MM-yyyy HH:mm:ss");
            ...
            PlayerPrefs.SetInt("Gols", otherScore);
            SceneManager.LoadScene("Menu");
        }

        float speed = new Vector3(characterController.velocity.x, 3.0f, characterController.velocity.z).magnitude;
    ...
    private void UpdateScore()
    {
        ...
        // Atualizar o placar
        textScore.text = " YOU    " + otherScore + "   " + myScore + "    BOT";
